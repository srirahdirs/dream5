...
<div class="slim-mainpanel">
    <div class="container">
        ...
        <div class="section-wrapper">
            <form method="post" action="<?php echo base_url('admin/games/add'); ?>">
                <label class="section-title">Add Game</label>
                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?= form_input(array('name' => 'game_type', 'class' => 'form-control', 'placeholder' => 'Game Type','autocomplete' => "off", 'value' => set_value('game_type'))); ?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?= form_input(array('name' => 'team_a', 'class' => 'form-control', 'placeholder' => 'Team A','autocomplete' => "off", 'value' => set_value('team_a'))); ?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?= form_input(array('name' => 'team_b', 'class' => 'form-control', 'placeholder' => 'Team B','autocomplete' => "off", 'value' => set_value('team_b'))); ?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="birthdaytime" name="match_date_time" class="form-control">
