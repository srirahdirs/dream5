...
?>
<title>Tandem - Edit Country</title>
<div class="slim-mainpanel">
    <div class="container">
        ...
        <div class="section-wrapper">
            <form method="post" action="<?php echo base_url('admin/countries/edit/') .$country->id; ?>">
                <label class="section-title">Edit Country</label>
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <?= form_input(array('name' => 'country', 'class' => 'form-control', 'placeholder' => 'Country Name','autocomplete' => "off", 'value' => $country->country )); ?>
