...
<div class="slim-sidebar">
        ...
        <ul class="nav nav-sidebar">
          ...
          <li class="sidebar-nav-item with-sub">
            <a href="<?= site_url('myprofile') ?>" class="sidebar-nav-link"><i class="icon ion-ios-contact"></i> My Profile</a>
            <ul class="nav sidebar-nav-sub">
              <li class="nav-sub-item "><a href="<?= site_url('myprofile') ?>" class="nav-sub-link">Edit Profile</a></li>
          ...
          <li class="sidebar-nav-item">
            <a href="page-messages.html" class="sidebar-nav-link"><i class="icon ion-cash"></i> ADD CASH</a>
          </li>
          <li class="sidebar-nav-item with-sub">
