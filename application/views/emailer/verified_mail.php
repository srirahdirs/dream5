                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width: 680px;min-width: 360px;width: 100%;">
                        <tr>
                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p>Your email has beed verified successfully.</p><br>
                                <p>                                   
                                    <a href="<?= $link ?>" style="font-family: sans-serif;font-size: 15px;line-height: 15px; color:#000;background: #FFDD00;padding:10px 20px;text-decoration:none;border-radius:10px;"><?= 'Login' ?></a>
                                </p>
