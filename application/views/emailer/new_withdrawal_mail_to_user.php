                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width: 680px;min-width: 360px;width: 100%;">
                        <tr>
                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p>Your IMPS withdrawal request from dream5.in has been processed, You will get the amount as soon as processed.</p>

                                <p>For any withdrawal related concerns, write to us on info@dream5.in else visit the support page on dream5.in website.
                                </p><br>
