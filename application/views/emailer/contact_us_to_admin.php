                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width: 680px;min-width: 360px;width: 100%;">
                        <tr>
                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <p style="margin: 0 0 20px;">Hi <b>YZT Admin!</b>,</p>
                                <p>Here below the user details contacted on the form</p>
                                <p>First Name : <?= $first_name ?></p><br>
                                <p>Last Name : <?= $last_name ?></p><br>
                                <p>Email : <?= $email ?></p><br>
                                <p>Mobile Number : <?= $mobile_number ?></p><br>
                                <p>User Query : <?= $user_query ?></p><br>
